...
async function start() {
    ...
    // let pr = await processEnvironments(envList, prompt);
    // console.log(pr);

    //get the list of cache for every env
    // push cache list for env key in an object
    // pass that object to prompt and get user input
    // filter the input based in cache list
    // pass the filtered list to the get cache method
    // pass the definition to the save function
}
