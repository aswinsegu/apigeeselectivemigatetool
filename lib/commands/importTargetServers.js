...
async function start(pathToTargetServers) {
...
module.exports.start = start(pathToTargetServers);
...
async function checkForExistence(list, envList) {
    ...
    let alreadyOnTarget = await getTargetServersForSpecificEnvs(envsToCheckFor);
...
function getTargetServersForSpecificEnvs(envsToCheckFor) {
