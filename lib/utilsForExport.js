...
async function getListOfEntities(entityType) {
    ...
    if(entityType === "proxy"){
        ...
        //console.log("request.url in getlist ", request.url);
        try{
...
module.exports.getListOfEntities = getListOfEntities;
 ...
 // getListOfEntities("proxy").then((proxies)=>{
 //
 //
 //     console.log(typeof JSON.parse(proxies));
 //
 // }).catch(function (e) {
 //     return console.log(e);
 // });
...
// function getListOfAllTargetServers(envList) {
//
//     envList.forEach(async (env)=>{
//        let targetServers = await getListOfTargetServers(env);
//
//     });
// }
//
// module.exports.getListOfAllTargetServers = getListOfAllTargetServers;
